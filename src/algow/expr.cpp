...
// namespace w {
// ExprBase::TIResult ExprBase::ti(const TypeEnv &env, TIBase &t) const {
...
// ExprBase::TIResult ExprVar::tiImpl(const TypeEnv &env, TIBase &t) const {
...
// ExprBase::TIResult ExprApp::tiImpl(const TypeEnv &env, TIBase &t) const {
//   auto a        = t.makeVar();
...
// ExprBase::TIResult ExprAbs::tiImpl(const TypeEnv &env, TIBase &t) const {
//   auto a        = t.makeVar();
//   auto env2     = env;
...
// ExprBase::TIResult ExprLet::tiImpl(const TypeEnv &env, TIBase &t) const {
