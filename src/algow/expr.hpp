...
protected:
  virtual TIResult tiImpl(const TypeEnv &, TI &) const = 0;

public:
  TIResult ti(const TypeEnv &, TI &) const;
...
protected:
  virtual TIResult tiImpl(const TypeEnv &, TI &) const;
...
protected:
  virtual TIResult tiImpl(const TypeEnv &env, TI &t) const override {
